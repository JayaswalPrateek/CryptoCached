...
class App(customtkinter.CTk):
    ...
    def __init__(self):
        ...
        my_image = customtkinter.CTkImage(light_image=Image.open(r"C:\Users\Vedant\Desktop\Projects\SEM 2\PP\prj\logo-removebg-preview.png"),dark_image=Image.open(r"C:\Users\Vedant\Desktop\Projects\SEM 2\PP\prj\logo-removebg-preview.png"),size=(200,200))
    ...
    def error_box(self,txt):
        ...
        labl = customtkinter.CTkLabel(window,font=("HGGothicE",15),width=380,height=180,text=txt).pack(padx = 10,pady =10)
        return(0)
    ...
    def f_to_b(self,func):
        ...
        if(crypt1_box1 and crypt1_box2 and crypt2_box1 and crypt2_box2):
            disp =True
            a = backend.main2(self.Currency_choice_optionemenu.get()[0:3],crypt1_box2,crypt1_box1,crypt2_box2,crypt2_box1,choice,func)                 
